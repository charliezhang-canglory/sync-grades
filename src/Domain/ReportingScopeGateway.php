...
class ReportingScopeGateway extends QueryableGateway
{
    ...
    public function selectScopesByID($reportingScopeID)
    {
        $sql = "SELECT * FROM `gibbonReportingScope` WHERE gibbonReportingScopeID = $reportingScopeID";

        return $this->db()->selectOne($sql);
    }

    public function getScopeBycritera($criteriaSelector, $gibbonReportingScopeID, $gibbonReportingCycleID)
    {
        $sql = "SELECT gibbonReportingScope.* FROM `gibbonCourseClass` 
        JOIN `gibbonReportingCriteria` ON gibbonCourseClass.gibbonCourseID=gibbonReportingCriteria.gibbonCourseID and gibbonCourseClass.gibbonCourseClassID=$criteriaSelector 
        JOIN gibbonReportingScope ON gibbonReportingCriteria.gibbonReportingScopeID=gibbonReportingScope.gibbonReportingScopeID and gibbonReportingScope.gibbonReportingScopeID=$gibbonReportingScopeID and gibbonReportingScope.gibbonReportingCycleID=$gibbonReportingCycleID;";
